...
function YandexIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M14.5 17.5L12 13h-1.5v4.5H8V6.5h4c2.5 0 4.5 1.5 4.5 3.5c0 1.5-1 2.5-2 3l2.5 4.5h-2.5zM10.5 11h1.5c1 0 2-.5 2-1.5s-1-1.5-2-1.5h-1.5V11z" fill="white"/>
    </svg>
  );
}
